...
import com.example.letngo.databinding.FragmentSecond3Binding;
...
public class Second3Fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonSecond.setOnClickListener(view1 -> NavHostFragment.findNavController(Second3Fragment.this)
