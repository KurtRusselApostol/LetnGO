...
public class FragmentNotification extends Fragment {
    ...
    VPAdapter_Notification notificationAdapter;
    ...
    private void addFragment(View view) {
        ...
        viewPager = view.findViewById(R.id.viewPagerNotif);

        FragmentManager fm = getChildFragmentManager();
        notificationAdapter = new VPAdapter_Notification(fm, getLifecycle());
